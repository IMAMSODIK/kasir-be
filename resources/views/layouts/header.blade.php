    ...
    <div class="header-wrapper row m-0">
                ...
                <div class="Typeahead Typeahead--twitterUsers">
                    <div class="u-posRelative">
                        <input class="demo-input Typeahead-input form-control-plaintext w-100" type="text"
                            placeholder="Search Riho .." name="q" title="">
        ...
        <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"> <a href="index.html"><img class="img-fluid for-light"
                        src="{{ asset('dashboard_assets/assets/images/logo/logo_dark.png') }}" alt="logo-light"
                        style="width: 85px; margin-top: -20px"><img class="img-fluid for-dark"
                        src="{{ asset('dashboard_assets/assets/images/logo/logo.png') }}" alt="logo-dark"
                        style="width: 85px; margin-top: -20px"></a>
            </div>
            ...
            <ul class="nav-menus">
                                            ...
                                            <div class="user-message">
                                                        ...
                                                        <li class="pr-0 pl-0 pb-3 pt-3">
                                                            <div class="media"><img
                                                                ...
                                                                <div class="media-body"><a class="f-light f-w-500"
                                                                        href="{{ asset('dashboard_assets/template/product.h') }}tml">Men
                                                                        Blue T-Shirt</a>
                                                                    <div class="qty-box">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        <div class="user-alerts"><img
                                                                class="user-image rounded-circle img-fluid me-2"
                                                                src="{{ asset('dashboard_assets/assets/images/dashboard/user/6.jpg') }}"
                                                                alt="user" />
                                                            <div class="user-name">
                                                                <div>
                                                                    <h6><a class="f-w-500 f-14"
                                                ...
                                                <ul>
                                                    ...
                                                    <li
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="user-alerts flex-shrink-0"><img
                                                                    class="rounded-circle img-fluid img-40"
                                                                    src="{{ asset('dashboard_assets/assets/images/dashboard/user/7.jpg') }}"
                                                                    alt="user" /></div>
                                                            <div class="flex-grow-1">
                                                                <div class="common-space user-id w-100">
                                                                    <div class="common-space w-100"> <a
                                                ...
                                                <ul>
                                                    <li class="pr-0 pl-0 pb-3">
                                                        <div class="media"><img class="img-fluid b-r-5 me-3 img-60"
                                                                src="{{ asset('dashboard_assets/assets/images/other-images/cart-img.jpg') }}"
                                                                alt="">
                                                            <div class="media-body"><a class="f-light f-w-500"
                                                    ...
                                                    <li class="pr-0 pl-0 pb-3 pt-3">
                                                        <div class="media"><img class="img-fluid b-r-5 me-3 img-60"
                                                                ...
                                                                alt="">
                                                            <div class="media-body"><a class="f-light f-w-500"
                                                                    href="../template/product.html">Men Cotton
                ...
                <li class="profile-nav onhover-dropdown">
                    <div class="media profile-media">
                        @if (auth()->user()->foto)
                            <img class="b-r-10" src="{{ asset('storage') . '/' . auth()->user()->foto }}" style="width: 31px;" alt="Profile Picture">
                        @else
                            <img class="b-r-10" src="{{ asset('own_assets/images/avatar.png') }}" style="width: 41px;" alt="Profile Picture">
                        @endif

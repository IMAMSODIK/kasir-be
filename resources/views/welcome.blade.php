...
<head>
    ...
    <link rel="icon" href="{{asset('landing_assets/images/logo/favicon.png')}}" type="image/x-icon">
    <title>zomo Web</title>
    <link rel="apple-touch-icon" href="{{asset('landing_assets/images/logo/favicon.png')}}">
    <meta name="theme-color" content="#ff8d2f">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="black">
    <meta name="apple-mobile-web-app-title" content="zomo">
    <meta name="msapplication-TileImage" content="{{asset('landing_assets/images/logo/favicon.png')}}">
    ...
    <!-- bootstrap css -->
    <link rel="stylesheet" id="rtl-link" href="{{asset('landing_assets/css/vendors/bootstrap.css')}}">

    <!-- swiper css -->
    <link rel="stylesheet" type="text/css" href="{{asset('landing_assets/css/vendors/swiper-bundle.min.css')}}">

    <!-- remixicon css -->
    <link rel="stylesheet" type="text/css" href="{{asset('landing_assets/css/vendors/remixicon.css')}}">

    <!-- Theme css -->
    <link rel="stylesheet" id="change-link" type="text/css" href="{{asset('landing_assets/css/style.css')}}">
</head>
...
<body class="position-relative">
        ...
        <header>
            <div class="container">
                <nav class="navbar navbar-expand-lg p-0">
                    ...
                    <a href="index.html">
                        <img class="img-fluid logo" src="{{asset('landing_assets/images/svg/logo.svg')}}" alt="logo">
                    </a>
                    ...
                    <div class="nav-option order-md-2">
                        ...
                        <div class="profile-part dropdown-button order-md-2">
                            <img class="img-fluid profile-pic" src="{{asset('landing_assets/images/icons/p5.png')}}" alt="profile">
                            <div>
        ...
        <section class="home-wrapper">
            <div class="container text-center">
                <div class="loader-gif">
                    <img src="{{asset('landing_assets/images/gif/food.gif')}}" alt="food-gif" class="img-fluid">
                </div>
                        ...
                        <div class="onhover-box">
                            <ul class="cart-list">
                                <li class="product-box-contain">
                                    <div class="drop-cart">
                                        <a href="#!" class="drop-image">
                                            <img src="{{asset('landing_assets/images/product/vp-3.png')}}" class="blur-up lazyloaded" alt="">
                                        </a>
                                ...
                                <li class="product-box-contain">
                                    <div class="drop-cart">
                                        <a href="#!" class="drop-image">
                                            <img src="{{asset('landing_assets/images/product/vp-2.png')}}" class="blur-up lazyloaded" alt="">
                                        </a>
                                        <div class="drop-contain">
                                            <a href="#!">
                                ...
                                <li class="product-box-contain">
                                    <div class="drop-cart">
                                        <a href="#!" class="drop-image">
                                            <img src="{{asset('landing_assets/images/product/vp-4.png')}}" class="blur-up lazyloaded" alt="">
                                        </a>
                                        <div class="drop-contain">
                                            <a href="#!">
                                ...
                                <li class="product-box-contain">
                                    <div class="drop-cart">
                                        <a href="#!" class="drop-image">
                                            <img src="{{asset('landing_assets/images/product/vp-6.png')}}" class="blur-up lazyloaded" alt="">
                                        </a>
                                        <div class="drop-contain">
                                            <a href="#!">
                                    ...
                                    <div class="row row-cols-lg-5 row-cols-1 g-xl-4 g-3">
                                        <div class="col">
                                            <a href="index.html" class="demo-box" target="_blank">
                                                <img src="{{asset('landing_assets/images/demo/1.html')}}" alt="d-1"
                                        ...
                                        <div class="col">
                                            <a href="index2.html" class="demo-box" target="_blank">
                                                <img src="{{asset('landing_assets/images/demo/2.html')}}" alt="d-2"
                                                    class="img-fluid demo-img">
                                        ...
                                        <div class="col">
                                            <a href="index5.html" class="demo-box" target="_blank">
                                                <img src="{{asset('landing_assets/images/demo/3.html')}}" alt="d-3"
                                                    class="img-fluid demo-img">
                                        ...
                                        <div class="col">
                                            <a href="index4.html" class="demo-box" target="_blank">
                                                <img src="{{asset('landing_assets/images/demo/4.html')}}" alt="d-4"
                                                    class="img-fluid demo-img">
                                        ...
                                        <div class="col">
                                            <a href="index3.html" class="demo-box" target="_blank">
                                                <img src="{{asset('landing_assets/images/demo/5.html')}}" alt="d-5"
                                                    class="img-fluid demo-img">
                                                <h5 class="dropdown-item">Modern</h5>
                                            </a>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="container text-center">
            <div class="row">
                ...
                <div class="col-lg-5 position-relative">
                    <img src="{{asset('landing_assets/images/home-vector.png')}}" class="img-fluid right-vector" alt="right-vector">
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="categories-section">
        <img src="{{asset('landing_assets/images/popcorn.png')}}" class="img-fluid popcorn-img" alt="">
        <div class="container">
            <div class="position-relative category-top">
                <div class="swiper categories-no-arrow categories-style">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <a href="restaurant-listing.html" class="food-categories">
                                <img class="img-fluid categories-img" src="{{asset('landing_assets/images/product/p-1.png')}}" alt="p-1">
                                <h4 class="dark-text">Pizza</h4>
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="restaurant-listing.html" class="food-categories">
                                <img class="img-fluid categories-img" src="{{asset('landing_assets/images/product/p-2.png')}}" alt="p-2">
                                <h4 class="dark-text">Chicken</h4>
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="restaurant-listing.html" class="food-categories">
                                <img class="img-fluid categories-img" src="{{asset('landing_assets/images/product/p-3.png')}}" alt="p-3">
                                <h4 class="dark-text">Burger</h4>
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="restaurant-listing.html" class="food-categories">
                                <img class="img-fluid categories-img" src="{{asset('landing_assets/images/product/p-5.png')}}" alt="p-5">
                                <h4 class="dark-text">Fries</h4>
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="restaurant-listing.html" class="food-categories">
                                <img class="img-fluid categories-img" src="{{asset('landing_assets/images/product/p-6.png')}}" alt="p-6">
                                <h4 class="dark-text">Boritto</h4>
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="restaurant-listing.html" class="food-categories">
                                <img class="img-fluid categories-img" src="{{asset('landing_assets/images/product/p-7.png')}}" alt="p-7">
                                <h4 class="dark-text">Taco</h4>
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="restaurant-listing.html" class="food-categories">
                                <img class="img-fluid categories-img" src="{{asset('landing_assets/images/product/p-8.png')}}" alt="p-8">
                                <h4 class="dark-text">Muffin</h4>
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="restaurant-listing.html" class="food-categories">
                                <img class="img-fluid categories-img" src="{{asset('landing_assets/images/product/p-9.png')}}" alt="p-9">
                                <h4 class="dark-text">Meat</h4>
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="restaurant-listing.html" class="food-categories">
                                <img class="img-fluid categories-img" src="{{asset('landing_assets/images/product/p-10.png')}}" alt="p-5">
                                <h4 class="dark-text">Panner</h4>
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="restaurant-listing.html" class="food-categories">
                                <img class="img-fluid categories-img" src="{{asset('landing_assets/images/product/p-11.png')}}" alt="p-11">
                                <h4 class="dark-text">Hotdog</h4>
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="restaurant-listing.html" class="food-categories">
                                <img class="img-fluid categories-img" src="{{asset('landing_assets/images/product/p-12.png')}}" alt="p-12">
                                <h4 class="dark-text">Donuts</h4>
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="restaurant-listing.html" class="food-categories">
                                <img class="img-fluid categories-img" src="{{asset('landing_assets/images/product/p-13.png')}}" alt="p-13">
                                <h4 class="dark-text">Coffee</h4>
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="restaurant-listing.html" class="food-categories">
                                <img class="img-fluid categories-img" src="{{asset('landing_assets/images/product/p-14.png')}}" alt="p-14">
                                <h4 class="dark-text">Sandwich</h4>
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="restaurant-listing.html" class="food-categories">
                                <img class="img-fluid categories-img" src="{{asset('landing_assets/images/product/p-15.png')}}" alt="p-15">
                                <h4 class="dark-text">Noddle</h4>
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="restaurant-listing.html" class="food-categories">
                                <img class="img-fluid categories-img" src="{{asset('landing_assets/images/product/p-16.png')}}" alt="p-16">
                                <h4 class="dark-text">Pasta</h4>
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="restaurant-listing.html" class="food-categories">
                                <img class="img-fluid categories-img" src="{{asset('landing_assets/images/product/p-17.png')}}" alt="p-17">
                                <h4 class="dark-text">Meggi</h4>
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="restaurant-listing.html" class="food-categories">
                                <img class="img-fluid categories-img" src="{{asset('landing_assets/images/product/p-18.png')}}" alt="p-18">
                                <h4 class="dark-text">Momos</h4>
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="restaurant-listing.html" class="food-categories">
                                <img class="img-fluid categories-img" src="{{asset('landing_assets/images/product/p-19.png')}}" alt="p-19">
                                <h4 class="dark-text">Salad</h4>
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="restaurant-listing.html" class="food-categories">
                                <img class="img-fluid categories-img" src="{{asset('landing_assets/images/product/p-20.png')}}" alt="p-20">
                ...
                <div class="swiper banner1-slider">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="banner-part">
                                <a href="offer.html">
                                    <img class="img-fluid banner-img" src="{{asset('landing_assets/images/banner/banner1.jpg')}}"
                                        alt="banner">
                                </a>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="banner-part">
                                <a href="offer.html">
                                    <img class="img-fluid banner-img" src="{{asset('landing_assets/images/banner/banner2.jpg')}}"
                                        alt="banner">
                                </a>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="banner-part">
                                <a href="offer.html">
                                    <img class="img-fluid banner-img" src="{{asset('landing_assets/images/banner/banner3.jpg')}}"
                                        alt="banner">
                                </a>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="banner-part">
                                <a href="offer.html">
                                    <img class="img-fluid banner-img" src="{{asset('landing_assets/images/banner/banner4.jpg')}}"
                                        alt="banner">
                                </a>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="banner-part">
                                <a href="offer.html">
                                    <img class="img-fluid banner-img" src="{{asset('landing_assets/images/banner/banner5.jpg')}}"
                                        alt="banner">
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="row g-lg-4 g-3">
                            ...
                            <div class="vertical-product-box">
                                <div class="vertical-product-box-img">
                                    <a href="menu-listing.html">
                                        <img class="product-img-top w-100 bg-img" src="{{asset('landing_assets/images/product/vp-9.png')}}"
                                            alt="vp1">
                                    </a>
                                    <div class="offers">
                                        <h6>upto $2</h6>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="vertical-product-box">
                                <div class="seller-badge">
                                    <img class="img-fluid badge" src="{{asset('landing_assets/images/svg/medal-fill.svg')}}" alt="medal">
                                    <h6>Exclusive</h6>
                                </div>
                                <div class="vertical-product-box-img">
                                    <a href="menu-listing.html">
                                        <img class="vertical-product-img-top w-100 bg-img"
                                            src="{{asset('landing_assets/images/product/vp-10.png')}}" alt="vp-2">
                                    </a>
                                    <div class="offers">
                                        <h6>upto $2</h6>
                                        <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="vertical-product-box">
                                <div class="vertical-product-box-img">
                                    <a href="menu-listing.html">
                                        <img class="product-img-top w-100 bg-img" src="{{asset('landing_assets/images/product/vp-11.png')}}"
                                            alt="vp3">
                                    </a>
                                </div>
                                <div class="vertical-product-body">
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="vertical-product-box">
                                <div class="vertical-product-box-img">
                                    <a href="menu-listing.html">
                                        <img class="product-img-top w-100 bg-img" src="{{asset('landing_assets/images/product/vp-12.png')}}"
                                            alt="vp-4">
                                    </a>
                                </div>
                                <div class="vertical-product-body">
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="vertical-product-box">
                                <div class="vertical-product-box-img">
                                    <a href="menu-listing.html">
                                        <img class="product-img-top w-100 bg-img" src="{{asset('landing_assets/images/product/vp-13.png')}}"
                                            alt="vp-5">
                                    </a>
                                </div>
                                <div class="vertical-product-body">
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="vertical-product-box">
                                <div class="vertical-product-box-img">
                                    <a href="menu-listing.html">
                                        <img class="product-img-top w-100 bg-img" src="{{asset('landing_assets/images/product/vp-14.png')}}"
                                            alt="vp16">
                                    </a>
                                    <div class="offers">
                                        <h6>upto $2</h6>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="vertical-product-box">
                                <div class="seller-badge exclusive-badge">
                                    <img class="img-fluid badge" src="{{asset('landing_assets/images/svg/crown.svg')}}" alt="medal">
                                    <h6>Best seller</h6>
                                </div>
                                <div class="vertical-product-box-img">
                                    <a href="menu-listing.html">
                                        <img class="vertical-product-img-top w-100 bg-img"
                                            src="{{asset('landing_assets/images/product/vp-15.png')}}" alt="vp-7">
                                    </a>
                                    <div class="offers">
                                        <h6>upto $2</h6>
                                        <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="vertical-product-box">
                                <div class="seller-badge new-badge">
                                    <img class="img-fluid badge" src="{{asset('landing_assets/images/svg/star-white.svg')}}" alt="medal">
                                    <h6>Newest</h6>
                                </div>
                                <div class="vertical-product-box-img">
                                    <a href="menu-listing.html">
                                        <img class="vertical-product-img-top w-100 bg-img"
                                            src="{{asset('landing_assets/images/product/vp-16.png')}}" alt="vp-8">
                                    </a>
                                    <div class="offers">
                                        <h6>upto $2</h6>
                                        <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="row g-lg-4 g-3">
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="vertical-product-box">
                                <div class="vertical-product-box-img">
                                    <a href="menu-listing.html">
                                        <img class="product-img-top w-100 bg-img" src="{{asset('landing_assets/images/product/vp-1.png')}}"
                                            alt="vp1">
                                    </a>
                                    <div class="offers">
                                        <h6>upto $2</h6>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="vertical-product-box">
                                ...
                                <div class="vertical-product-box-img">
                                    <a href="menu-listing.html">
                                        <img class="vertical-product-img-top w-100 bg-img"
                                            src="{{asset('landing_assets/images/product/vp-2.png')}}" alt="vp-2">
                                    </a>
                                    <div class="offers">
                                        <h6>upto $2</h6>
                                        <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="vertical-product-box">
                                <div class="vertical-product-box-img">
                                    <a href="menu-listing.html">
                                        <img class="product-img-top w-100 bg-img" src="{{asset('landing_assets/images/product/vp-3.png')}}"
                                            alt="vp3">
                                    </a>
                                </div>
                                <div class="vertical-product-body">
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="vertical-product-box">
                                <div class="vertical-product-box-img">
                                    <a href="menu-listing.html">
                                        <img class="product-img-top w-100 bg-img" src="{{asset('landing_assets/images/product/vp-4.png')}}"
                                            alt="vp-4">
                                    </a>
                                </div>
                                <div class="vertical-product-body">
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="vertical-product-box">
                                <div class="vertical-product-box-img">
                                    <a href="menu-listing.html">
                                        <img class="product-img-top w-100 bg-img" src="{{asset('landing_assets/images/product/vp-5.png')}}"
                                            alt="vp-5">
                                    </a>
                                </div>
                                <div class="vertical-product-body">
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="vertical-product-box">
                                <div class="vertical-product-box-img">
                                    <a href="menu-listing.html">
                                        <img class="product-img-top w-100 bg-img" src="{{asset('landing_assets/images/product/vp-6.png')}}"
                                            alt="vp16">
                                    </a>
                                    <div class="offers">
                                        <h6>upto $2</h6>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="vertical-product-box">
                                ...
                                <div class="vertical-product-box-img">
                                    <a href="menu-listing.html">
                                        <img class="vertical-product-img-top w-100 bg-img"
                                            src="{{asset('landing_assets/images/product/vp-7.png')}}" alt="vp-7">
                                    </a>
                                    <div class="offers">
                                        <h6>upto $2</h6>
                                        <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="vertical-product-box">
                                ...
                                <div class="vertical-product-box-img">
                                    <a href="menu-listing.html">
                                        <img class="vertical-product-img-top w-100 bg-img"
                                            src="{{asset('landing_assets/images/product/vp-8.png')}}" alt="vp-8">
                                    </a>
                                    <div class="offers">
                                        <h6>upto $2</h6>
                                        <div class="d-flex align-items-center justify-content-between">
    ...
    <section class="brand-section">
        <img class="img-fluid item-4" src="{{asset('landing_assets/images/svg/item4.svg')}}" alt="item-4">
        <div class="container">
            <div class="title">
                <h2>Brand For You</h2>
                <div class="loader-line"></div>
                ...
                <div class="swiper brands-logo">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="brand-box">
                                <a href="menu-listing.html" class="food-brands">
                                    <img class="img-fluid brand-img" src="{{asset('landing_assets/images/icons/brand1.png')}}" alt="brand1">
                                </a>
                                <a href="menu-listing.html">
                                    <h4>La Pino’z</h4>
                                </a>
                        ...
                        <div class="swiper-slide">
                            <div class="brand-box">
                                <a href="menu-listing.html" class="food-brands">
                                    <img class="img-fluid brand-img" src="{{asset('landing_assets/images/icons/brand2.png')}}" alt="brand2">
                                </a>
                                <a href="menu-listing.html">
                                    <h4>Mc'd</h4>
                                </a>
                        ...
                        <div class="swiper-slide">
                            <div class="brand-box">
                                <a href="menu-listing.html" class="food-brands">
                                    <img class="img-fluid brand-img" src="{{asset('landing_assets/images/icons/brand3.png')}}" alt="brand3">
                                </a>
                                <a href="menu-listing.html">
                                    <h4>Starbucks</h4>
                                </a>
                        ...
                        <div class="swiper-slide">
                            <div class="brand-box">
                                <a href="menu-listing.html" class="food-brands">
                                    <img class="img-fluid brand-img" src="{{asset('landing_assets/images/icons/brand4.png')}}" alt="brand2">
                                </a>
                                <a href="menu-listing.html">
                                    <h4>Pizza Hut</h4>
                                </a>
                        ...
                        <div class="swiper-slide">
                            <div class="brand-box">
                                <a href="menu-listing.html" class="food-brands">
                                    <img class="img-fluid brand-img" src="{{asset('landing_assets/images/icons/brand5.png')}}" alt="brand2">
                                </a>
                                <a href="menu-listing.html">
                                    <h4>Wendy's</h4>
                                </a>
                        ...
                        <div class="swiper-slide">
                            <div class="brand-box">
                                <a href="menu-listing.html" class="food-brands">
                                    <img class="img-fluid brand-img" src="{{asset('landing_assets/images/icons/brand6.png')}}" alt="brand6">
                                </a>
                                <a href="menu-listing.html">
                                    <h4>Burger King</h4>
                                </a>
                        ...
                        <div class="swiper-slide">
                            <div class="brand-box">
                                <a href="menu-listing.html" class="food-brands">
                                    <img class="img-fluid brand-img" src="{{asset('landing_assets/images/icons/brand7.png')}}" alt="brand7">
                                </a>
                                <a href="menu-listing.html">
                                    <h4>Subway</h4>
                                </a>
                        ...
                        <div class="swiper-slide">
                            <div class="brand-box">
                                <a href="menu-listing.html" class="food-brands">
                                    <img class="img-fluid brand-img" src="{{asset('landing_assets/images/icons/brand8.png')}}" alt="brand8">
                                </a>
                                <a href="menu-listing.html">
                                    <h4>Domino's</h4>
                                </a>
                        ...
                        <div class="swiper-slide">
                            <div class="brand-box">
                                <a href="menu-listing.html" class="food-brands">
                                    <img class="img-fluid brand-img" src="{{asset('landing_assets/images/icons/brand9.png')}}" alt="brand9">
                                </a>
                                <a href="menu-listing.html">
                                    <h4>Taco Bell</h4>
                                </a>
                        ...
                        <div class="swiper-slide">
                            <div class="brand-box">
                                <a href="menu-listing.html" class="food-brands">
                                    <img class="img-fluid brand-img" src="{{asset('landing_assets/images/icons/brand10.png')}}" alt="brand5">
                                </a>
                                <a href="menu-listing.html">
                                    <h4>Chipotle</h4>
                                </a>
                        ...
                        <div class="swiper-slide">
                            <div class="brand-box">
                                <a href="menu-listing.html" class="food-brands">
                                    <img class="img-fluid brand-img" src="{{asset('landing_assets/images/icons/brand11.png')}}"
                                        alt="brand11">
                                </a>
                                <a href="menu-listing.html">
                                    <h4>KFC</h4>
    ...
    <section class="popular-restaurant section-b-space ratio3_2 overflow-hidden">
        <img class="img-fluid item-5" src="{{asset('landing_assets/images/svg/item5.svg')}}" alt="item-5">
        <div class="container">
            <div class="title">
            ...
            <div class="row g-4">
                ...
                <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="vertical-product-box">
                        ...
                        <div class="vertical-product-box-img">
                            <a href="menu-listing.html">
                                <img class="vertical-product-img-top w-100 bg-img" src="{{asset('landing_assets/images/product/vp-2.png')}}"
                                    alt="vp-2">
                            </a>
                            <div class="offers">
                                <h6>upto $2</h6>
                ...
                <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="vertical-product-box">
                        ...
                        <div class="vertical-product-box-img">
                            <a href="menu-listing.html">
                                <img class="vertical-product-img-top w-100 bg-img" src="{{asset('landing_assets/images/product/vp-7.png')}}"
                                    alt="vp-7">
                            </a>
                            <div class="offers">
                                <h6>upto $2</h6>
                ...
                <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="vertical-product-box">
                        ...
                        <div class="vertical-product-box-img">
                            <a href="menu-listing.html">
                                <img class="vertical-product-img-top w-100 bg-img" src="{{asset('landing_assets/images/product/vp-8.png')}}"
                                    alt="vp-8">
                            </a>
                            <div class="offers">
                                <h6>upto $2</h6>
    ...
    <section class="app-section">
        <div class="container">
            <div class="d-flex align-items-center">
                <div class="app-img">
                    <img class="img-fluid phone" src="{{asset('landing_assets/images/service-phone.png')}}" alt="app-phone">
                </div>
                <div class="app-content">
                    ...
                    <div class="app-buttons d-flex align-items-center gap-3">
                        <a href="https://www.apple.com/in/app-store/">
                            <img class="img-fluid app-btn" src="{{asset('landing_assets/images/svg/app-store.svg')}}" alt="app-store">
                        </a>
                        <a href="https://play.google.com/store/apps">
                            <img class="img-fluid app-btn" src="{{asset('landing_assets/images/svg/google-play.svg')}}" alt="google-play">
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="bottom-footer-part">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    ...
                    <img class="img-fluid cards" src="{{asset('landing_assets/images/icons/footer-card.png')}}" alt="card">
                </div>
            </div>
        </div>
    </footer>
    ...
    <!-- footer accordion js -->
    <script src="{{asset('landing_assets/js/footer-accordion.js')}}"></script>

    <!-- loader js -->
    <script src="{{asset('landing_assets/js/loader.js')}}"></script>

    <!-- swiper js -->
    <script src="{{asset('landing_assets/js/swiper-bundle.min.js')}}"></script>
    <script src="{{asset('landing_assets/js/custom-swiper.js')}}"></script>

    <!-- menu offcanvas js -->
    <script src="{{asset('landing_assets/js/menu-offcanvas.js')}}"></script>
